class GuitarsController < ApplicationController
  ...
  private
    ...
    def guitar_params
      params.require(:guitar).permit(:serial, :model, :body_wood, :neck_wood, :fingerboard, :neck_shape, :scale_length, :nut_width, :nut_material, :frets, :fret_count, :inlays, :inlay_description, :hardware, :bridge, :tuners, :controls, :switch, :knobs, :pickups, :body_finish, :neck_finish, :strings, :case)
    end
end
